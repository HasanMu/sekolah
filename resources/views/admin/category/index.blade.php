...
<div class="card card-small mb-4">
    <div class="card-header border-bottom">
      <a class="btn btn-primary" href="{{ route('categories.create') }}" role="button">Tambah data</a>
    </div>
        ...
        <table class="table mb-0">
            ...
            <?php $no++ ?>
                <tr>
                    ...
                    <td>{{ $data->name }}</td>
                    <td>
                        <a class="btn btn-primary" href="{{ route('categories.edit', $data->id) }}" role="button">Edit Data</a>
                        <a class="btn btn-info" href="{{ route('categories.show', $data->id) }}" role="button">Detail Data</a>
                        <a class="btn btn-danger" href="{{ route('categories.edit', $data->id) }}" role="button">Hapus Data</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
